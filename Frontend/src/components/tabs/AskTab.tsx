...
import { User, Bot, Clock, ExternalLink, Copy, Loader2, MessageSquare, Send, Sparkles, FileText } from 'lucide-react';
      ...
      <div className="flex items-center justify-center h-full p-6">
        <div className="text-center space-y-8 max-w-lg w-full">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h1 className="text-2xl font-bold mb-2">Start Your AI Conversation</h1>
              <p className="text-muted-foreground text-lg">
                Load a YouTube video to unlock AI-powered insights and interactive conversations
              </p>
            </div>
          </div>
            ...
            <div className="w-full">
              <div className="bg-gradient-to-r from-card to-accent/5 rounded-xl border shadow-sm p-6 space-y-4">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-medium text-primary">Ready to analyze</span>
                  <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                </div>
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Ask questions about video content</p>
            </div>
            <div className="space-y-2">
              <div className="w-10 h-10 mx-auto rounded-lg bg-primary/10 flex items-center justify-center">
              ...
              <p className="text-xs text-muted-foreground">Generate quiz questions</p>
            </div>
            <div className="space-y-2">
              <div className="w-10 h-10 mx-auto rounded-lg bg-primary/10 flex items-center justify-center">
              ...
              <p className="text-xs text-muted-foreground">Analyze content patterns</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          {conversations.slice().reverse().map((conversation, index) => (
            <div key={index} className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-sm text-primary">System</span>
              ...
              {conversations.length - 1 - index > 0 && <Separator className="my-6" />}
            </div>
          ))}
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <Button
                ...
                disabled={!canAsk || question.length < 3 || question.length > 2000 || isAsking || isLoading}
